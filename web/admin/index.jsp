...
<html>
    ...
    <body>
        ...
        <header id="header" style="background-color: lightcoral">
		<hgroup>
			<h1 class="site_title"><a href="#">Administrator Page</a></h1>
		</hgroup>
        ...
        <aside id="sidebar" class="column" style="height: 620px; background-color: #B5E5EF; font-size: 15.5px;">
